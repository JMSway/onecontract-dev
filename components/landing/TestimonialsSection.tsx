    ...
    <section className="py-20 sm:py-28 bg-gray-50 px-4">
      <div className="max-w-6xl mx-auto">
        <FadeIn className="text-center mb-14">
          <span className="text-indigo-600 font-semibold text-sm uppercase tracking-widest">Отзывы</span>
          <h2 className="mt-3 text-3xl sm:text-4xl font-extrabold text-gray-900 tracking-tight">
            Школы уже работают без бумаги
          </h2>
          <p className="mt-4 text-gray-500 text-sm">
            * Отзывы участников пилотного тестирования
          </p>
        </FadeIn>
        ...
        <FadeIn delay={0.4} className="mt-12 text-center">
          <div className="inline-flex flex-col sm:flex-row items-center gap-6 sm:gap-12 bg-white rounded-2xl px-8 py-6 shadow-sm border border-gray-100">
            {[
